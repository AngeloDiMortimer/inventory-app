...
module.exports.get_category_create = asyncHandler(async (req, res, next) => {
...
module.exports.post_category_create = [
    //preguntarle a memi como llamar funcion de validacion en un array sin que se potee esta mierda
     ...
     asyncHandler(async (req, res) => {
       ...
       if (!result.isEmpty()) {
        // There are errors. Render the form again with sanitized values/error messages.
         ...
         await category.save();
         //category created, redirects to all page
